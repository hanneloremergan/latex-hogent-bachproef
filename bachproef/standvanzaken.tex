...
% segmentatie in de landbouw
% synth data - eigen simulatie of andere AI & 3D modelleering
% synth data augmentatie in landbouw (en andere sectoren)
% model verkleinen

% ZIE BRONNEN EN TEKST VOORSTEL - zie lijst eigen notities
...
\section{Computervisie in de precisielandbouw}
% wat is cv? 


% Voordelen cv in landbouw buiten segmentatie 

% en als laatste voordeel van segmentatie aanhalen om de volgende sectie in de leiden

...
Segmentatie biedt een gedetailleerdere visuele interpretatie dan objectdetectie en komt in twee vormen voor: semantische segmentatie en instantiesegmentatie. Bij semantische segmentatie worden alle objecten van dezelfde categorie in dezelfde kleur gemarkeerd, terwijl bij instantie-segmentatie elk individueel object binnen een categorie een unieke kleur krijgt toegewezen. Dit zorgt voor een onderling onderscheid tussen objecten binnen dezelfde klasse. 

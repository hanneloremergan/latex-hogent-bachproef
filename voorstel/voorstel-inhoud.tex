...
% WAAROM IS LANDBOUW LASTIG VOOR SEGMENTATIE

% 1 MODEL AL NEMEN (ZIE SLIDE WERKWIJZE)

% WAAROM IS SYTH DATA EEN OPLOSSING EN HOE MOET DIE ERUIT ZIEN

% MOGELIJKE OPTIMALISATIE TECHNIEKEN
